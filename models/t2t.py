...
class AttentionToken_transformer(nn.Module):
...
class Token_transformer(nn.Module):
    ...
    def __init__(self, dim, in_dim, num_heads, mlp_ratio=1., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        super().__init__()
        self.norm1 = norm_layer(dim)
        self.attn = AttentionToken_transformer(dim, in_dim=in_dim, num_heads=num_heads, qkv_bias=qkv_bias,
...
class T2T_ViT(nn.Module):
    ...
    def forward_features(self, x):
        ...
        for en, blk in enumerate(self.blocks):
            ...
            layers_ = {2:'0', 6:'1', 10:'2', 13:'3'}
            if en in layers_.keys():
                out['feat'+layers_[en]] = x[:, 1:]
